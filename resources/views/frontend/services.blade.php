...
@section('title', 'Services | Four Square Design')
    ...
    <div class="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-5 relative">
            ...
            <div class="workflow-step-card group relative z-10">
                ...
                {{-- Icon --}}
                <div class="w-11 h-11 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center mb-5 group-hover:bg-amber-500/15 group-hover:border-amber-500/35 transition-all duration-400">
                    <i data-lucide="{{ $step[1] }}" class="text-amber-500" size="20"></i>
                </div>
...
<!-- Bottom CTA -->
<section class="py-20 md:py-40 bg-slate-950 relative overflow-hidden">
    <div class="absolute bottom-0 right-0 w-[600px] h-[600px] bg-amber-500/5 blur-[150px] translate-x-1/2 translate-y-1/2 pointer-events-none"></div>
    <div class="container mx-auto px-6 lg:px-12 text-center relative z-10 space-y-12">
        <h2 class="text-3xl sm:text-5xl md:text-7xl font-serif italic text-white leading-tight">Elevate Your Next <br><span class="text-amber-500 not-italic font-bold">Design Vision</span></h2>
        <div class="pt-8">
            <a href="{{ url('/request') }}" class="btn-gold !px-20 !py-8 text-sm">
                Start Your Project
            </a>
        </div>
    </div>
