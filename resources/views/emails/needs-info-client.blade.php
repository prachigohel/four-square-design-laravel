...
<p class="message">
    We require additional information to continue working on your project. Please review the request and submit the required details at your earliest convenience.
</p>
...
<a href="{{ url('/portal/view-request/' . $designRequest->id) }}" class="btn">Submit Information</a>
@endsection
